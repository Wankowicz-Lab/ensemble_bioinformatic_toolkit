...
if [ -f "LIG.cif" ]; then
phenix.ensemble_refinement ${PDB}_refine_001.pdb ${PDB}_refine_001.mtz elbow.LIG.${PDB}.cif  ptls=0.8 wxray_coupled_tbath_offset=5 tx=0.8
else
phenix.ensemble_refinement ${PDB}_refine_001.pdb ${PDB}_refine_001.mtz ptls=0.8 wxray_coupled_tbath_offset=5 tx=0.8
fi
